...
public class OrderManagementMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Order Delivery");
        ...
        jButton3.setText("Pick Up Order");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderManagementMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrderManagementMenu().setVisible(true);
            }
        });
    }
